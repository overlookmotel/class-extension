...
// Imports
const {validateClass, validateExtension, validateInstance} = require('./shared'),
	{EXTENSIONS, NAMED_EXTENSIONS} = require('./symbols');
...
/**
 * Check if object is instace of a class which has been extended with specified extension.
